  ...
  <aside class="col-md-4 col-xs-12">
    <section class="sidebar-sns-section">
      ...
      <div class="sidebar-sns-links">
        <ShareNetwork network="twitter" url="" title="shareボタン" inline-template>
          <div class="twitter__share">
            <i class="fab fa-twitter"></i> Twitter
          </div>
        </ShareNetwork>
        <ShareNetwork network="facebook" url="" title="shareボタン" inline-template>
          <div class="facebook__share">
            <i class="fab fa-facebook"></i> Facebook
          </div>
        </ShareNetwork>
        <ShareNetwork network="line" url="" title="shareボタン" inline-template>
          <div class="line__share">
            <i class="fab fa-line"></i> Line
          </div>
        </ShareNetwork>
        <ShareNetwork network="googleplus" url="" title="shareボタン" inline-template>
